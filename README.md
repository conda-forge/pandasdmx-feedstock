About pandasdmx-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandasdmx-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9802&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandasdmx-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandasdmx` can be installed with `conda`:
...
```
mamba install pandasdmx
```

It is possible to list all of the versions of `pandasdmx` available on your platform with `conda`:
...
```
mamba search pandasdmx --channel conda-forge
```
...
mamba repoquery search pandasdmx --channel conda-forge

# List packages depending on `pandasdmx`:
mamba repoquery whoneeds pandasdmx --channel conda-forge

# List dependencies of `pandasdmx`:
mamba repoquery depends pandasdmx --channel conda-forge
```
